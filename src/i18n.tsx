...
const en: Dict = {
  ...
  'settings.statsHint': 'Lifetime challenge stats per difficulty.',
  'settings.statsTitle': 'Your stats',
  'settings.statsEmpty': 'No challenge runs recorded yet.',
  'settings.statsLine': '{level}: best {correct}/{total} ({accuracy}%) · {runs} runs',
  'settings.statsTotal': 'Total runs: {n}',
...
const nb: Dict = {
  ...
  'settings.statsHint': 'Total utfordringsstatistikk per vanskelighetsgrad.',
  'settings.statsTitle': 'Din statistikk',
  'settings.statsEmpty': 'Ingen utfordringer registrert ennå.',
  'settings.statsLine': '{level}: best {correct}/{total} ({accuracy}%) · {runs} forsøk',
  'settings.statsTotal': 'Totalt antall forsøk: {n}',
