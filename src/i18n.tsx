...
const en: Dict = {
  ...
  'challenge.best': 'Best ({level}): {score} pts · {correct} notes · {accuracy}%',
  ...
  'settings.unlockTitle': 'Reveal stats?',
  'settings.unlockMessage': 'Show the hidden stats button?',
  'settings.unlockConfirm': 'Show',
  'settings.stats': 'Stats',
  'settings.statsHint': 'Lifetime challenge bests per difficulty (score · correct/total · accuracy).',
  'settings.statsEmpty': 'No challenge runs recorded yet.',
  'settings.statsTotal': 'Total runs',
  'settings.resetStats': 'Reset stats',
  'settings.resetTitle': 'Reset stats?',
  'settings.resetMessage': 'This permanently deletes all challenge bests and history.',
...
const nb: Dict = {
  ...
  'challenge.best': 'Rekord ({level}): {score} poeng · {correct} noter · {accuracy}%',
  ...
  'settings.version': 'Versjon {v}',
  'settings.unlockTitle': 'Vis statistikk?',
  'settings.unlockMessage': 'Vil du vise den skjulte statistikk-knappen?',
  'settings.unlockConfirm': 'Vis',
  'settings.stats': 'Statistikk',
  'settings.statsHint': 'Beste utfordringer per vanskelighetsgrad (poeng · riktige/totalt · treffsikkerhet).',
  'settings.statsEmpty': 'Ingen utfordringer registrert ennå.',
  'settings.statsTotal': 'Totalt antall forsøk',
  'settings.resetStats': 'Nullstill statistikk',
  'settings.resetTitle': 'Nullstille statistikk?',
  'settings.resetMessage': 'Dette sletter all utfordringsstatistikk og historikk permanent.',
  'settings.resetConfirm': 'Nullstill',
