...
const en: Dict = {
  ...
  'home.battle': 'Battle mode',
  'home.battleSub': 'Race the clock for a high score',
...
const nb: Dict = {
  ...
  'home.battle': 'Kampmodus',
  'home.battleSub': 'Kjemp mot klokka om toppscore',
